...
$sql = "INSERT INTO suk_itposts (post_title, post_author, post_content, post_excerpt) VALUES ('".$_POST["post_title"]."','".$_POST["post_author"]."','".$_POST["post_content"]."','".$_POST["post_excerpt"]."')";
